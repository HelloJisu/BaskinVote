...
<body>
	<%
		...
		String[] color = { "#e8a1f7", "#f7a1a1", "#f9e588", "#bdd0ff", "#c0c0c0", "#abdca3", "#ffafb0", "#ffafd8",
				"#eeb7b4", "#fcffb0", "#aee4ff", "#b5c7ed", "#c4f4fe", "#bee9b4", "#dfd4e4", "#dfd4e4", "#caa6fe",
				"#afffba", "#e2ffaf" };
		...
		try {
			for (int i = 0; i < vote.length; i++) {
				String filePath = application.getRealPath("/WEB-INF/ice/" + vote[i] + ".txt");
